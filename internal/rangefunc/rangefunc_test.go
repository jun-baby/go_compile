...
// testGotoA1 tests loop-nest-cmd_internal goto, no bad iterators.
...
// testGotoA2 tests loop-nest-cmd_internal goto, outer bad iterator.
...
// testGotoA3 tests loop-nest-cmd_internal goto, inner bad iterator.
