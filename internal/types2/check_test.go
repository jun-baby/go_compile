...
func TestCheck(t *testing.T) {
	...
	DefPredeclaredTestFuncs()
	testDirFiles(t, "../../../../cmd_internal/types/testdata/check", 50, false) // TODO(gri) narrow column tolerance
}
func TestSpec(t *testing.T) {
	testDirFiles(t, "../../../../cmd_internal/types/testdata/spec", 0, false)
}
func TestExamples(t *testing.T) {
	testDirFiles(t, "../../../../cmd_internal/types/testdata/examples", 125, false)
} // TODO(gri) narrow column tolerance
func TestFixedbugs(t *testing.T) {
	testDirFiles(t, "../../../../cmd_internal/types/testdata/fixedbugs", 100, false)
}                            // TODO(gri) narrow column tolerance
