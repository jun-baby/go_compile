...
func (s *state) stmt(n ir.Node) {
	...
	case ir.OINTERFACESWITCH:
		...
		if base.Flag.N == 0 && rtabi.UseInterfaceSwitchCache(Arch.LinkArch.Name) {
			...
			if _, ok := intrinsics[intrinsicKey{Arch.LinkArch.Arch, "runtime/cmd_internal/atomic", "Loadp"}]; !ok {
...
func InitTables() {
	...
	addF("runtime/cmd_internal/math", "MulUintptr",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			if s.config.PtrSize == 4 {
	...
	/******** runtime/cmd_internal/sys ********/
	addF("runtime/cmd_internal/sys", "Bswap32",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			return s.newValue1(ssa.OpBswap32, types.Types[types.TUINT32], args[0])
		},
		brev_arch...)
	addF("runtime/cmd_internal/sys", "Bswap64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/cmd_internal/sys", "Prefetch", makePrefetchFunc(ssa.OpPrefetchCache),
		sys.AMD64, sys.ARM64, sys.PPC64)
	addF("runtime/cmd_internal/sys", "PrefetchStreamed", makePrefetchFunc(ssa.OpPrefetchCacheStreamed),
		sys.AMD64, sys.ARM64, sys.PPC64)

	/******** runtime/cmd_internal/atomic ********/
	addF("runtime/cmd_internal/atomic", "Load",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/cmd_internal/atomic", "Load8",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
		...
		sys.AMD64, sys.ARM64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/cmd_internal/atomic", "Load64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/cmd_internal/atomic", "LoadAcq",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
		...
		sys.PPC64, sys.S390X)
	addF("runtime/cmd_internal/atomic", "LoadAcq64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
		...
		sys.PPC64)
	addF("runtime/cmd_internal/atomic", "Loadp",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/cmd_internal/atomic", "Store",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicStore32, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/cmd_internal/atomic", "Store8",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicStore8, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/cmd_internal/atomic", "Store64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicStore64, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.Loong64, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/cmd_internal/atomic", "StorepNoWB",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicStorePtrNoWB, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.RISCV64, sys.S390X)
	addF("runtime/cmd_internal/atomic", "StoreRel",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicStoreRel32, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.PPC64, sys.S390X)
	addF("runtime/cmd_internal/atomic", "StoreRel64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/cmd_internal/atomic", "Xchg",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/cmd_internal/atomic", "Xchg64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/cmd_internal/atomic", "Xadd",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
		...
		sys.AMD64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/cmd_internal/atomic", "Xadd64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/cmd_internal/atomic", "Cas",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
		...
		sys.AMD64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/cmd_internal/atomic", "Cas64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
		...
		sys.AMD64, sys.Loong64, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/cmd_internal/atomic", "CasRel",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			v := s.newValue4(ssa.OpAtomicCompareAndSwap32, types.NewTuple(types.Types[types.TBOOL], types.TypeMem), args[0], args[1], args[2], s.mem())
			s.vars[memVar] = s.newValue1(ssa.OpSelect1, types.TypeMem, v)
			return s.newValue1(ssa.OpSelect0, types.Types[types.TBOOL], v)
	...
	addF("runtime/cmd_internal/atomic", "And8",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicAnd8, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/cmd_internal/atomic", "And",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicAnd32, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/cmd_internal/atomic", "Or8",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicOr8, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/cmd_internal/atomic", "Or",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	alias("runtime/cmd_internal/atomic", "Loadint32", "runtime/cmd_internal/atomic", "Load", all...)
	alias("runtime/cmd_internal/atomic", "Loadint64", "runtime/cmd_internal/atomic", "Load64", all...)
	alias("runtime/cmd_internal/atomic", "Loaduintptr", "runtime/cmd_internal/atomic", "Load", p4...)
	alias("runtime/cmd_internal/atomic", "Loaduintptr", "runtime/cmd_internal/atomic", "Load64", p8...)
	alias("runtime/cmd_internal/atomic", "Loaduint", "runtime/cmd_internal/atomic", "Load", p4...)
	alias("runtime/cmd_internal/atomic", "Loaduint", "runtime/cmd_internal/atomic", "Load64", p8...)
	alias("runtime/cmd_internal/atomic", "LoadAcq", "runtime/cmd_internal/atomic", "Load", lwatomics...)
	alias("runtime/cmd_internal/atomic", "LoadAcq64", "runtime/cmd_internal/atomic", "Load64", lwatomics...)
	alias("runtime/cmd_internal/atomic", "LoadAcquintptr", "runtime/cmd_internal/atomic", "LoadAcq", p4...)
	alias("sync", "runtime_LoadAcquintptr", "runtime/cmd_internal/atomic", "LoadAcq", p4...) // linknamed
	alias("runtime/cmd_internal/atomic", "LoadAcquintptr", "runtime/cmd_internal/atomic", "LoadAcq64", p8...)
	alias("sync", "runtime_LoadAcquintptr", "runtime/cmd_internal/atomic", "LoadAcq64", p8...) // linknamed

	// Aliases for atomic store operations
	alias("runtime/cmd_internal/atomic", "Storeint32", "runtime/cmd_internal/atomic", "Store", all...)
	alias("runtime/cmd_internal/atomic", "Storeint64", "runtime/cmd_internal/atomic", "Store64", all...)
	alias("runtime/cmd_internal/atomic", "Storeuintptr", "runtime/cmd_internal/atomic", "Store", p4...)
	alias("runtime/cmd_internal/atomic", "Storeuintptr", "runtime/cmd_internal/atomic", "Store64", p8...)
	alias("runtime/cmd_internal/atomic", "StoreRel", "runtime/cmd_internal/atomic", "Store", lwatomics...)
	alias("runtime/cmd_internal/atomic", "StoreRel64", "runtime/cmd_internal/atomic", "Store64", lwatomics...)
	alias("runtime/cmd_internal/atomic", "StoreReluintptr", "runtime/cmd_internal/atomic", "StoreRel", p4...)
	alias("sync", "runtime_StoreReluintptr", "runtime/cmd_internal/atomic", "StoreRel", p4...) // linknamed
	alias("runtime/cmd_internal/atomic", "StoreReluintptr", "runtime/cmd_internal/atomic", "StoreRel64", p8...)
	alias("sync", "runtime_StoreReluintptr", "runtime/cmd_internal/atomic", "StoreRel64", p8...) // linknamed

	// Aliases for atomic swap operations
	alias("runtime/cmd_internal/atomic", "Xchgint32", "runtime/cmd_internal/atomic", "Xchg", all...)
	alias("runtime/cmd_internal/atomic", "Xchgint64", "runtime/cmd_internal/atomic", "Xchg64", all...)
	alias("runtime/cmd_internal/atomic", "Xchguintptr", "runtime/cmd_internal/atomic", "Xchg", p4...)
	alias("runtime/cmd_internal/atomic", "Xchguintptr", "runtime/cmd_internal/atomic", "Xchg64", p8...)

	// Aliases for atomic add operations
	alias("runtime/cmd_internal/atomic", "Xaddint32", "runtime/cmd_internal/atomic", "Xadd", all...)
	alias("runtime/cmd_internal/atomic", "Xaddint64", "runtime/cmd_internal/atomic", "Xadd64", all...)
	alias("runtime/cmd_internal/atomic", "Xadduintptr", "runtime/cmd_internal/atomic", "Xadd", p4...)
	alias("runtime/cmd_internal/atomic", "Xadduintptr", "runtime/cmd_internal/atomic", "Xadd64", p8...)

	// Aliases for atomic CAS operations
	alias("runtime/cmd_internal/atomic", "Casint32", "runtime/cmd_internal/atomic", "Cas", all...)
	alias("runtime/cmd_internal/atomic", "Casint64", "runtime/cmd_internal/atomic", "Cas64", all...)
	alias("runtime/cmd_internal/atomic", "Casuintptr", "runtime/cmd_internal/atomic", "Cas", p4...)
	alias("runtime/cmd_internal/atomic", "Casuintptr", "runtime/cmd_internal/atomic", "Cas64", p8...)
	alias("runtime/cmd_internal/atomic", "Casp1", "runtime/cmd_internal/atomic", "Cas", p4...)
	alias("runtime/cmd_internal/atomic", "Casp1", "runtime/cmd_internal/atomic", "Cas64", p8...)
	alias("runtime/cmd_internal/atomic", "CasRel", "runtime/cmd_internal/atomic", "Cas", lwatomics...)
	...
	addF("math/bits", "TrailingZeros8",
		...
		sys.S390X)
	alias("math/bits", "ReverseBytes64", "runtime/cmd_internal/sys", "Bswap64", all...)
	alias("math/bits", "ReverseBytes32", "runtime/cmd_internal/sys", "Bswap32", all...)
	...
	alias("runtime/cmd_internal/math", "Mul64", "math/bits", "Mul64", p8...)
	...
	alias("runtime/cmd_internal/math", "Add64", "math/bits", "Add64", all...)
	...
	alias("runtime/cmd_internal/sys", "TrailingZeros8", "math/bits", "TrailingZeros8", all...)
	alias("runtime/cmd_internal/sys", "TrailingZeros32", "math/bits", "TrailingZeros32", all...)
	alias("runtime/cmd_internal/sys", "TrailingZeros64", "math/bits", "TrailingZeros64", all...)
	alias("runtime/cmd_internal/sys", "Len8", "math/bits", "Len8", all...)
	alias("runtime/cmd_internal/sys", "Len64", "math/bits", "Len64", all...)
	alias("runtime/cmd_internal/sys", "OnesCount64", "math/bits", "OnesCount64", all...)

	/******** sync/atomic ********/

	// Note: these are disabled by flag_race in findIntrinsic below.
	alias("sync/atomic", "LoadInt32", "runtime/cmd_internal/atomic", "Load", all...)
	alias("sync/atomic", "LoadInt64", "runtime/cmd_internal/atomic", "Load64", all...)
	alias("sync/atomic", "LoadPointer", "runtime/cmd_internal/atomic", "Loadp", all...)
	alias("sync/atomic", "LoadUint32", "runtime/cmd_internal/atomic", "Load", all...)
	alias("sync/atomic", "LoadUint64", "runtime/cmd_internal/atomic", "Load64", all...)
	alias("sync/atomic", "LoadUintptr", "runtime/cmd_internal/atomic", "Load", p4...)
	alias("sync/atomic", "LoadUintptr", "runtime/cmd_internal/atomic", "Load64", p8...)

	alias("sync/atomic", "StoreInt32", "runtime/cmd_internal/atomic", "Store", all...)
	alias("sync/atomic", "StoreInt64", "runtime/cmd_internal/atomic", "Store64", all...)
	// Note: not StorePointer, that needs a write barrier.  Same below for {CompareAnd}Swap.
	alias("sync/atomic", "StoreUint32", "runtime/cmd_internal/atomic", "Store", all...)
	alias("sync/atomic", "StoreUint64", "runtime/cmd_internal/atomic", "Store64", all...)
	alias("sync/atomic", "StoreUintptr", "runtime/cmd_internal/atomic", "Store", p4...)
	alias("sync/atomic", "StoreUintptr", "runtime/cmd_internal/atomic", "Store64", p8...)

	alias("sync/atomic", "SwapInt32", "runtime/cmd_internal/atomic", "Xchg", all...)
	alias("sync/atomic", "SwapInt64", "runtime/cmd_internal/atomic", "Xchg64", all...)
	alias("sync/atomic", "SwapUint32", "runtime/cmd_internal/atomic", "Xchg", all...)
	alias("sync/atomic", "SwapUint64", "runtime/cmd_internal/atomic", "Xchg64", all...)
	alias("sync/atomic", "SwapUintptr", "runtime/cmd_internal/atomic", "Xchg", p4...)
	alias("sync/atomic", "SwapUintptr", "runtime/cmd_internal/atomic", "Xchg64", p8...)

	alias("sync/atomic", "CompareAndSwapInt32", "runtime/cmd_internal/atomic", "Cas", all...)
	alias("sync/atomic", "CompareAndSwapInt64", "runtime/cmd_internal/atomic", "Cas64", all...)
	alias("sync/atomic", "CompareAndSwapUint32", "runtime/cmd_internal/atomic", "Cas", all...)
	alias("sync/atomic", "CompareAndSwapUint64", "runtime/cmd_internal/atomic", "Cas64", all...)
	alias("sync/atomic", "CompareAndSwapUintptr", "runtime/cmd_internal/atomic", "Cas", p4...)
	alias("sync/atomic", "CompareAndSwapUintptr", "runtime/cmd_internal/atomic", "Cas64", p8...)

	alias("sync/atomic", "AddInt32", "runtime/cmd_internal/atomic", "Xadd", all...)
	alias("sync/atomic", "AddInt64", "runtime/cmd_internal/atomic", "Xadd64", all...)
	alias("sync/atomic", "AddUint32", "runtime/cmd_internal/atomic", "Xadd", all...)
	alias("sync/atomic", "AddUint64", "runtime/cmd_internal/atomic", "Xadd64", all...)
	alias("sync/atomic", "AddUintptr", "runtime/cmd_internal/atomic", "Xadd", p4...)
	alias("sync/atomic", "AddUintptr", "runtime/cmd_internal/atomic", "Xadd64", p8...)
...
// descriptor is a compiler-allocated cmd_internal/abi.TypeAssert whose address is passed to runtime.typeAssert when
