...
// cross-references) are handled by cmd_internal/pkgbits, so here we only
...
// fatalf reports an cmd_internal compiler error about thing p.
...
func (pw *pkgWriter) objIdx(obj types2.Object) pkgbits.Index {
	...
	//   unaffected by cmd_internal compiler changes.
	//
...
// If typ is a type parameter, then isInterface reports an cmd_internal
...
func (w *writer) op(op ir.Op) {
	...
	// export data more stable against cmd_internal refactorings, but low
