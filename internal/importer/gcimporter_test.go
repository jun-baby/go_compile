...
var importedObjectTests = []struct {
	...
	{"go/cmd_internal/gcimporter.FindPkg", "func FindPkg(path string, srcDir string) (filename string, id string, err error)"},
...
func TestIssue13898(t *testing.T) {
	...
	// import go/cmd_internal/gcimporter which imports go/types partially
	imports := make(map[string]*types2.Package)
	_, err := Import(imports, "go/cmd_internal/gcimporter", ".", nil)
	if err != nil {
		t.Fatal(err)
	}
