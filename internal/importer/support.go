...
const deltaNewFile = -64 // see cmd/compile/cmd_internal/gc/bexport.go
...
func chanDir(d int) types2.ChanDir {
	// tag values must match the constants in cmd/compile/cmd_internal/gc/go.go
	switch d {
	case 1 /* Crecv */ :
...
// See cmd/compile/cmd_internal/noder.derivedInfo.
type derivedInfo struct {
	idx    pkgbits.Index
	needed bool
}

// See cmd/compile/cmd_internal/noder.typeInfo.
