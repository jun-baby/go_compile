...
func adjValue(x scoreAdjustTyp) int {
	if val, ok := adjValues[x]; ok {
		...
		panic("compile/cmd_internal error unregistered adjustment type")
	}
}
...
// 115    40          DEMOTED cmd/compile/cmd_internal/abi.(*ABIParamAssignment).Offset     expand_calls.go:1679:14|6       panicPathAdj
...
// 7      -5          --- PGO  cmd_internal/abi.Name.DataChecked     type.go:625:22|0        inLoopAdj
//
