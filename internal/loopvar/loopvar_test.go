...
func TestLoopVarInlinesGo1_21(t *testing.T) {
	...
	root := "compile/cmd_internal/loopvar/testdata/inlines"
...
func TestLoopVarHashes(t *testing.T) {
	...
	for _, arg := range []string{"v001100110110110010100100", "vx336ca4"} {
		...
		mCount := countMatches(m, "loopvarhash triggered cmd/compile/cmd_internal/loopvar/testdata/inlines/main.go:27:6: .* 001100110110110010100100")
		...
		mCount = countMatches(m, "compile/cmd_internal/loopvar/testdata/inlines/main.go:27:6: .* \\[bisect-match 0x7802e115b9336ca4\\]")
