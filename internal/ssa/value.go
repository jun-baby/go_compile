...
// ResultReg returns the result register assigned to v, in cmd/cmd_internal/obj/$ARCH numbering.
...
// Reg returns the register assigned to v, in cmd/cmd_internal/obj/$ARCH numbering.
...
// Reg0 returns the register assigned to the first output of v, in cmd/cmd_internal/obj/$ARCH numbering.
...
// Reg1 returns the register assigned to the second output of v, in cmd/cmd_internal/obj/$ARCH numbering.
...
// RegTmp returns the temporary register assigned to v, in cmd/cmd_internal/obj/$ARCH numbering.
