...
// Most cmd_internal data structures are pre-allocated and flat, so for instance adding a
...
type poset struct {
	...
	flags     uint8             // cmd_internal flags
...
// CheckIntegrity verifies cmd_internal integrity of a poset. It is intended
