...
// for "cmd/cmd_internal/dwarf" and <autogenerated> (which is not really a file, but the compiler sees it)
//
...
//
// {"version":0,"package":"compile/cmd_internal/ssa","goos":"darwin","goarch":"amd64",
//  "gc_version":"devel +e1b9a57852 Fri Nov 1 15:07:00 2019 -0400",
//  "file":"/Users/drchase/work/go/src/cmd/compile/cmd_internal/ssa/prove.go"}
//
...
//  "relatedInformation":[
//    {"location":{"uri":"file:///Users/drchase/work/go/src/cmd/compile/cmd_internal/ssa/func.go",
...
// (copied from tools/cmd_internal/span/uri.go)
...
func parseLogPath(destination string) (string, string) {
	...
	if strings.HasPrefix(destination, "file://") { // IKWIAD, or Windows C:\foo\bar\baz
		...
		if isWindowsDriveURIPath(destination) {
			...
			// unlike tools/cmd_internal/span/uri.go, do not uppercase the drive letter -- let filepath.Clean do what it does.
