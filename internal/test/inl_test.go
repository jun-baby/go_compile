...
import (
	"bufio"
	"compile/src_internal/goexperiment"
...
func TestIntendedInlining(t *testing.T) {
	...
	if runtime.GOARCH != "386" {
		...
		want["runtime/cmd_internal/sys"] = append(want["runtime/cmd_internal/sys"], "TrailingZeros64")
		want["runtime/cmd_internal/sys"] = append(want["runtime/cmd_internal/sys"], "TrailingZeros32")
		want["runtime/cmd_internal/sys"] = append(want["runtime/cmd_internal/sys"], "Bswap32")
	}
	if runtime.GOARCH == "amd64" || runtime.GOARCH == "arm64" || runtime.GOARCH == "loong64" || runtime.GOARCH == "mips" || runtime.GOARCH == "mips64" || runtime.GOARCH == "ppc64" || runtime.GOARCH == "riscv64" || runtime.GOARCH == "s390x" {
		// runtime/cmd_internal/atomic.Loaduintptr is only intrinsified on these platforms.
