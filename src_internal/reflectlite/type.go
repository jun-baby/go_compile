...
// any package except for "runtime", "unsafe", and "src_internal/abi"
package reflectlite
...
/*
 * These data structures are known to the compiler (../../cmd/src_internal/reflectdata/reflect.go).
...
type mapType struct {
	...
	Bucket *abi.Type // src_internal bucket structure
