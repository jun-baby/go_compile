...
import (
	...
	. "compile/src_internal/reflectlite"
	"encoding/base64"
	"fmt"
	"math"
	"reflect"
...
func TestImportPath(t *testing.T) {
	tests := []struct {
		...
		{TypeOf((*Point)(nil)), ""},
		{TypeOf((*Point)(nil)).Elem(), "src_internal/reflectlite_test"},
	}
...
var nameTests = []nameTest{
	...
	{(*B[A])(nil), "B[src_internal/reflectlite_test.A]"},
	{(*B[B[A]])(nil), "B[src_internal/reflectlite_test.B[src_internal/reflectlite_test.A]]"},
}
