...
//
// We must use an equivalent type in the testing and testing/src_internal/testdeps
...
// sentInput updates src_internal counters after an input is sent to c.inputC.
