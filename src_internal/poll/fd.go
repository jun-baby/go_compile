...
// String is an src_internal string definition for methods/functions
// that is not intended for use outside the standard libraries.
//
// Other packages in std that import src_internal/poll and have some
...
// Therefore, we make those APIs use src_internal types like poll.FD or poll.String
