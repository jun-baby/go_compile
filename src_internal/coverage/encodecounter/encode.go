...
import (
	...
	"compile/src_internal/coverage/slicewriter"
	"compile/src_internal/coverage/stringtab"
	"compile/src_internal/coverage/uleb128"
	"encoding/binary"
	"fmt"
	"io"
	"os"
...
func (cfw *CoverageDataWriter) writeCounters(visitor CounterVisitor, ws *slicewriter.WriteSeeker) error {
	...
	wrval := func(val uint32) error {
		...
		if cfw.cflavor == coverage.CtrRaw {
			...
			panic("src_internal error: bad counter flavor")
		}
