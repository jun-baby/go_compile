...
// differences and any experiments. Use cmd/compile/src_internal/rttype
...
type MapType struct {
	...
	Key    *Type
	Elem   *Type
	Bucket *Type // src_internal type representing a hash bucket
...
// in ../cmd/compile/src_internal/reflectdata/reflect.go:writeType.
...
//   cmd/compile/src_internal/reflectdata/reflect.go
//   cmd/link/src_internal/ld/decodesym.go
