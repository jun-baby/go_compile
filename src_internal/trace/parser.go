...
const (
	...
	EvUserTaskCreate    = 45 // trace.NewTask [timestamp, src_internal task id, src_internal parent id, name string, stack]
	EvUserTaskEnd       = 46 // end of task [timestamp, src_internal task id, stack]
	EvUserRegion        = 47 // trace.WithRegion [timestamp, src_internal task id, mode(0:start, 1:end), name string, stack]
	EvUserLog           = 48 // trace.Log [timestamp, src_internal id, key string id, stack, value string]
