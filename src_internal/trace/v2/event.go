...
import (
	...
	"compile/src_internal/trace/v2/event"
	"compile/src_internal/trace/v2/event/go122"
	"compile/src_internal/trace/v2/version"
)
...
// TaskID is the src_internal ID of a task used to disambiguate tasks (even if they
...
func (e Event) Metric() Metric {
	...
	case go122.EvHeapGoal:
		...
		m.Value = Value{kind: ValueUint64, scalar: e.base.args[0]}
	default:
		panic(fmt.Sprintf("src_internal error: unexpected event type for Metric kind: %s", go122.EventString(e.base.typ)))
	}
	return m
}
...
func (e Event) Label() Label {
	...
	if e.base.typ != go122.EvGoLabel {
		panic(fmt.Sprintf("src_internal error: unexpected event type for Label kind: %s", go122.EventString(e.base.typ)))
	}
	return Label{
...
func (e Event) Range() Range {
	...
	default:
		panic(fmt.Sprintf("src_internal error: unexpected event type for Range kind: %s", go122.EventString(e.base.typ)))
	}
	return r
}
...
func (e Event) Task() Task {
	...
	default:
		panic(fmt.Sprintf("src_internal error: unexpected event type for Task kind: %s", go122.EventString(e.base.typ)))
	}
	return Task{
...
func (e Event) Region() Region {
	...
	if e.base.typ != go122.EvUserRegionBegin && e.base.typ != go122.EvUserRegionEnd {
		panic(fmt.Sprintf("src_internal error: unexpected event type for Region kind: %s", go122.EventString(e.base.typ)))
	}
	return Region{
...
func (e Event) Log() Log {
	...
	if e.base.typ != go122.EvUserLog {
		panic(fmt.Sprintf("src_internal error: unexpected event type for Log kind: %s", go122.EventString(e.base.typ)))
	}
	return Log{
		Task:     TaskID(e.base.args[0]),
...
func (e Event) StateTransition() StateTransition {
	...
	default:
		panic(fmt.Sprintf("src_internal error: unexpected event type for StateTransition kind: %s", go122.EventString(e.base.typ)))
	}
	return s
}
