...
const (
	...
	EvUserTaskBegin   // trace.NewTask [timestamp, src_internal task ID, src_internal parent task ID, name string ID, stack ID]
	EvUserTaskEnd     // end of a task [timestamp, src_internal task ID, stack ID]
	EvUserRegionBegin // trace.{Start,With}Region [timestamp, src_internal task ID, name string ID, stack ID]
	EvUserRegionEnd   // trace.{End,With}Region [timestamp, src_internal task ID, name string ID, stack ID]
	EvUserLog         // trace.Log [timestamp, src_internal task ID, key string ID, stack, value string ID]
)
