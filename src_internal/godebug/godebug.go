...
// that src_internal/godebug imports cannot itself import src_internal/godebug,
// meaning it cannot introduce a GODEBUG setting of its own.
// We keep imports to the absolute bare minimum.
import (
	"compile/src_internal/bisect"
	"compile/src_internal/godebugs"
	"sync"
	"sync/atomic"
	"unsafe"
...
//
// Value maintains an src_internal cache that is synchronized
