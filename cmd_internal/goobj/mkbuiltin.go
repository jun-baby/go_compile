...
// Generate builtinlist.go from cmd/compile/cmd_internal/typecheck/builtin/runtime.go.
...
func mkbuiltin(w io.Writer) {
	...
	path := filepath.Join("..", "..", "compile", "compile/cmd_internal", "typecheck", "_builtin", "runtime.go")
