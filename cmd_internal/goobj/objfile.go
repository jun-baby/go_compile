...
// code below:
//
// - cmd/cmd_internal/obj/objfile.go (used by cmd/asm and cmd/compile)
// - cmd/cmd_internal/objfile/goobj.go (used cmd/nm, cmd/objdump)
// - cmd/link/cmd_internal/loader package (used by cmd/link)
//
