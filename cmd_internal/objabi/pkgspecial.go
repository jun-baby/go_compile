...
var runtimePkgs = []string{
	...
	"runtime/cmd_internal/syscall",

	"compile/cmd_internal/abi",
	"compile/cmd_internal/bytealg",
	"compile/cmd_internal/chacha8rand",
	"compile/cmd_internal/coverage/rtcov",
	"compile/cmd_internal/cpu",
	"compile/cmd_internal/goarch",
	"compile/cmd_internal/godebugs",
	"compile/cmd_internal/goexperiment",
	"compile/cmd_internal/goos",
}
...
var allowAsmABIPkgs = []string{
	...
	"compile/cmd_internal/chacha8rand",
	"runtime/cmd_internal/syscall",
	"runtime/cmd_internal/startlinetest",
}
