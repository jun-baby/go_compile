...
import (
	"bytes"
	"compile/cmd_internal/bio"
	"compile/cmd_internal/goobj"
	"compile/cmd_internal/notsha256"
...
// Some of these conditions are duplicated in cmd/link/cmd_internal/ld.(*Link).symtab.
...
func (w *writer) refNames() {
	...
	// Currently tools (cmd/cmd_internal/goobj package) doesn't use mmap,
