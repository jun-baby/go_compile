...
import (
	"compile/cmd_internal/cov"
	"compile/src_internal/coverage"
	"compile/src_internal/coverage/decodecounter"
	"compile/src_internal/coverage/decodemeta"
	"compile/src_internal/coverage/pods"
